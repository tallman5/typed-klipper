...
export class FanGeneric extends ConfigurableComponent {
  constructor(
    configKey: string,
    public pin?: string,
  ...
  static fromCfg(configKey: string, config: any): FanGeneric {
    return new FanGeneric(
      configKey,
      config.pin,
      config.max_power,
  ...
  static fromJson(configKey: string, config: any): FanGeneric {
    return new FanGeneric(
      configKey,
      config.pin,
      config.max_power,
