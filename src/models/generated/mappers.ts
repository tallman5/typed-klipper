...
export const moonrakerToComponentMapper: { pattern: RegExp, handler: (configKey: string, config: any) => Models.IConfigurableComponent }[] = [
    ...
    { pattern: /^gcode_shell_command/, handler: (configKey, json) => Models.GcodeShellCommand.fromJson(configKey, json) },
    ...
    { pattern: /^ratos_homing/, handler: (configKey, json) => Models.RatosHoming.fromJson(configKey, json) },
