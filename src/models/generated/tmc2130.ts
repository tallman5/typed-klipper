...
export class Tmc2130 extends ConfigurableComponent {
  constructor(
    configKey: string,
  ...
  toJSON(): any {
    return {
      [this.configKey]: {
        ...
        driver_PWM_AMPL: this.driver_PWM_AMPL,
...
`;
    ...
    if (this.driver_PWM_AMPL) configStr += `driver_PWM_AMPL: ${this.driver_PWM_AMPL}\n`;
  ...
  static fromCfg(configKey: string, config: any): Tmc2130 {
    return new Tmc2130(
      configKey,
      config.cs_pin,
      config.run_current,
  ...
  static fromJson(configKey: string, config: any): Tmc2130 {
    return new Tmc2130(
      configKey,
      config.cs_pin,
      config.run_current,
